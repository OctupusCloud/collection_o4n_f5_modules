...
DOCUMENTATION = r'''
---
module: o4n_bigip_profile_persistence_dest_addr
short_description: Manage destination address persistence profiles
description:
  - Manages destination address persistence profiles on a BIG-IP.
version_added: "1.0.0"
options:
  name:
    description:
  ...
  parent:
    description:
      ...
      - When creating a new profile, if this parameter is not specified, the default
        is the system-supplied C(destination_addr) profile.
    type: str
...
from ansible_collections.f5networks.f5_modules.plugins.module_utils.teem import send_teem
...
class ModuleManager(object):
    ...
    def exists(self):
        uri = "https://{0}:{1}/mgmt/tm/ltm/persistence/dest-addr/{2}".format(
    ...
    def create_on_device(self):
        ...
        uri = "https://{0}:{1}/mgmt/tm/ltm/persistence/dest-addr/".format(
            self.client.provider['server'],
            self.client.provider['server_port']
        )
